...
exports.updateLiveChannels = updateLiveChannels;
exports.startLiveStreamCron = startLiveStreamCron;
...
async function fetchLiveVideoId(youtubeHandle) {
...
async function updateLiveChannels() {
    ...
    try {
        let channels = await LiveChannel_1.LiveChannel.find();
        // Seed database if empty
        if (channels.length === 0) {
            console.log('[LiveStreamUpdater] Seeding initial channel database...');
            await LiveChannel_1.LiveChannel.insertMany(INITIAL_CHANNELS);
            channels = await LiveChannel_1.LiveChannel.find();
        }
...
//# sourceMappingURL=liveStreamUpdater.js.map