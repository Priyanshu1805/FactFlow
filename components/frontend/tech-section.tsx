...
export function TechSection() {
  ...
  useEffect(() => {
    const fetchNews = () => {
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/news?category=Tech&limit=4`)
        .then((res) => res.json())
        .then((data) => {
    ...
    <section id="tech" className={`py-16 px-4 ${
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <Link href="/tech" className="flex items-center gap-1.5 text-purple-500 text-sm font-semibold hover:text-purple-400 transition-colors">
                ...
                <Link href={`/article/${featured.id}`} className="lg:col-span-2 group cursor-pointer block">
                  <motion.article
                    ...
                    className={`rounded-xl overflow-hidden border ${
                      isDark ? "bg-white/5 border-white/10 hover:border-purple-500/30" : "bg-white border-gray-200 shadow-sm hover:shadow-md"
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto">
                      ...
                      <div className={`pt-4 border-t ${isDark ? "border-white/10 text-purple-400" : "border-gray-200 text-purple-600"} font-semibold text-sm flex items-center gap-1 group-hover:gap-2 transition-all`}>
