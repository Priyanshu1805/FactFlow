      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`fixed top-16 left-4 right-4 sm:absolute sm:top-auto sm:left-auto sm:right-0 mt-3 sm:w-[350px] rounded-2xl shadow-2xl border overflow-hidden z-[200] ${
              isDark
