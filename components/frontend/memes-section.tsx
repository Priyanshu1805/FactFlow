...
export function MemesSection() {
  ...
  useEffect(() => {
    const fetchNews = () => {
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/news?category=Memes&limit=4`)
        .then((res) => res.json())
        .then((data) => {
    ...
    <section id="memes" className={`py-16 px-4 ${
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <Link href="/memes" className="flex items-center gap-1.5 text-purple-500 text-sm font-semibold hover:text-purple-400 transition-colors">
                ...
                <Link href={`/article/${featured.id}`} className="lg:col-span-2 group cursor-pointer block">
                  <motion.article
                    ...
                    className={`rounded-xl overflow-hidden border ${
                      isDark ? "bg-white/5 border-white/10 hover:border-yellow-500/30" : "bg-white border-gray-200 shadow-sm hover:shadow-md"
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto">
                      ...
                      <div className={`mt-auto pt-4 border-t ${isDark ? "border-white/10 text-yellow-400" : "border-gray-100 text-yellow-500"} font-semibold text-sm flex items-center gap-1 group-hover:gap-2 transition-all`}>
